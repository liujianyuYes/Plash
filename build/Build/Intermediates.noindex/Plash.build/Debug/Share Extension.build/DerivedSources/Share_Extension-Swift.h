...
SWIFT_CLASS("_TtC15Share_Extension19ExtensionController")
...
/// 分享扩展入口，把系统分享来的网页 URL 转换为 <code>plash:add</code> 命令。
SWIFT_CLASS("_TtC15Share_Extension15ShareController")
@interface ShareController : ExtensionController
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end
